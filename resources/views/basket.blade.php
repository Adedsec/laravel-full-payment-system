                    ...
                    <tbody>
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td>
                                    <form class="form-inline" action="{{ route('basket.update', $item->id) }}" method="post">
                                        @csrf
                                        ...
                                        <button type="submit" class=" mr-sm-1 btn btn-primary btn-sm">@lang('payment.update')</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
